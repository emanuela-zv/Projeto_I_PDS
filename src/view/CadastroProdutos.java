...
public class CadastroProdutos extends JPanel {
	...
	public CadastroProdutos() {
		...
		add(logo, "cell 1 1,alignx center,aligny center");
		...
		add(lbGerenciarProdutos, "cell 1 2,alignx center,aligny center");
